...
class ResultsByPIN extends StatefulWidget {
  final List slots;
  ResultsByPIN({required this.slots});

  @override
  _ResultsByPINState createState() => _ResultsByPINState();
}

class _ResultsByPINState extends State<ResultsByPIN> {
  @override
